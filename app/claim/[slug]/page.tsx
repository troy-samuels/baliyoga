...
export default async function ClaimPage({ params }: { params: { slug: string } }) {
  ...
  return <ClaimForm businessName={businessName} businessSlug={params.slug} />
}

function ClaimForm({ businessName, businessSlug }: { businessName: string, businessSlug: string }) {
